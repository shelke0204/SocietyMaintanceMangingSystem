...
function ResidentLoginApp() {
  try {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100" data-name="resident-login-app" data-file="resident-login-app.js">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[var(--text-primary)]">Resident Login</h1>
            <p className="text-[var(--text-secondary)] mt-2">Access your resident portal</p>
          </div>
    ...
    console.error('ResidentLoginApp component error:', error);
    return null;
  }
}
