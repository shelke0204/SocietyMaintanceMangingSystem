...
function PaymentGatewayApp() {
  try {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100" data-name="payment-gateway-app" data-file="payment-gateway-app.js">
        <PaymentGateway />
      </div>
    );
  } catch (error) {
    console.error('PaymentGatewayApp component error:', error);
    return null;
  }
}
